var _createClass = function () {function defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function (Constructor, protoProps, staticProps) {if (protoProps) defineProperties(Constructor.prototype, protoProps);if (staticProps) defineProperties(Constructor, staticProps);return Constructor;};}();function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}var BackgroundImage = function () {
  function BackgroundImage() {_classCallCheck(this, BackgroundImage);
    this.uniforms = {
      resolution: {
        type: 'v2',
        value: new THREE.Vector2(picWidth, picHeight) },
    ...
    this.obj = null;
  }_createClass(BackgroundImage, [{ key: 'init', value: function init(
    src, callback) {var _this = this;
    ...
    {
      this.uniforms.resolution.value.set(picWidth, picHeight);
    }
  ...
  }_createClass(PostEffect, [{ key: 'createObj', value: function createObj()
    {
      return new THREE.Mesh(
      new THREE.PlaneBufferGeometry(2, 2),
      new THREE.RawShaderMaterial({
...
var renderBack1 = new THREE.WebGLRenderTarget(picWidth, picHeight);
var scene = new THREE.Scene();
var sceneBack = new THREE.Scene();
var camera = new THREE.OrthographicCamera(-1, 1, 1, -1, 0, 1);
var cameraBack = new THREE.PerspectiveCamera(45, picWidth / picHeight, 1, 10000);
...
var resizeWindow = function resizeWindow() {
  ...
  cameraBack.aspect = picWidth / picHeight;
  cameraBack.updateProjectionMatrix();
  bgImg.resize();
  postEffect.resize();
  renderBack1.setSize(picWidth, picHeight);
  renderer.setSize(picWidth, picHeight);
};
